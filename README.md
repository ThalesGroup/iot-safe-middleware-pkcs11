...
to cross compile the library, you can configure `CC` and `CXX` variable inside [project-build.sh](project-build.sh). You may need to reinstall the dependency based on your target machine
