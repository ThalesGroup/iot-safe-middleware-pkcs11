...
#define CRYPTOKIVERSION_LIBRARY_MAJOR 1
#define CRYPTOKIVERSION_LIBRARY_MINOR 0
#define CRYPTOKIVERSION_LIBRARY_MINOR2 0
#define CRYPTOKIVERSION_LIBRARY_MINOR3 0

//Same definitions in string format in order to be compliant with .rc file syntax
#define STRCRYPTOKIVERSION_LIBRARY_MAJOR "1"
#define STRCRYPTOKIVERSION_LIBRARY_MINOR "0"
#define SRTCRYPTOKIVERSION_LIBRARY_MINOR2 "0"
#define STRCRYPTOKIVERSION_LIBRARY_MINOR3 "0"
