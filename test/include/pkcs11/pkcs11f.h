...
#ifdef CK_NEED_ARG_LIST
(
  CK_SESSION_HANDLE l_hSession,  /* the session's handle */
...
#ifdef CK_NEED_ARG_LIST
(
  CK_SESSION_HANDLE l_hSession,             /* session's handle */
...
#ifdef CK_NEED_ARG_LIST
(
  CK_SESSION_HANDLE l_hSession,                /* session handle */
...
#ifdef CK_NEED_ARG_LIST
(
  CK_SESSION_HANDLE    l_hSession,                    /* session
                                                     * handle */
